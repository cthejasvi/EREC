...
<script>
    ...
    alert(" supplier  details has been edited!");
    // Delay the form reset by 1 second (1000 milliseconds)
    setTimeout(function() {
        document.getElementById("editsuplierForm").reset();
    }, 1000);
}
...
<form id="editsuplierForm" action="saveeditsupplier.php" method="post" onsubmit="displayPopup()">
