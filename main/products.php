...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			...
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM products where qty < 10 ORDER BY product_id ");
				$result->execute();
...
<Button type="submit" id="popupbutton" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Product</button></a><br><br><br>
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;"><br>
	<thead>
		<tr>
			<th width="12%">Product_id</th>
			<th width="14%">Product_Name  </th>
			<th width="13%"> Category_id</th>
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../connect.php');
				$result = $db->prepare("SELECT *, price * qty as total FROM products ORDER BY product_id ");
				$result->execute();
			...
			<td>C<?php echo $row['category_id']; ?></td>
